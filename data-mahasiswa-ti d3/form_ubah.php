...
<div class="bg-white rounded-4 shadow-sm p-4 mb-5">
    ...
    <div class="alert alert-primary rounded-4 mb-5" role="alert">
        <i class="fa-solid fa-pen-to-square me-2"></i> Ubah Data mahasiswa
    </div>
    <!-- form ubah data -->
            ...
            <div class="col-xl-6">
                <div class="row g-0">
                    <div class="mb-3 col-xl-6 pe-xl-3">
                        ...
                        <input type="text" name="id_mahasiswa" class="form-control" value="<?php echo $data['id_mahasiswa']; ?>" readonly>
                    </div>
        ...
        <div class="row">
            <div class="col-xl-6">
                <div class="mb-3 pe-xl-3">
                    ...
                    <input type="text" name="nim" class="form-control" autocomplete="off" value="<?php echo $data['nim']; ?>" required>
                    <div class="invalid-feedback">Nim tidak boleh kosong.</div>
                </div>

                    <div class="mb-3 col-xl-6 pe-xl-3">
                        <label class="form-label">tanggal lahir <span class="text-danger">*</span></label>
                        <input type="text" name="tanggal_lahir" class="form-control datepicker" autocomplete="off" value="<?php echo date('d-m-Y', strtotime($data['tanggal_lahir'])); ?>" required>
