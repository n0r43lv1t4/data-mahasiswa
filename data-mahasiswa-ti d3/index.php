...
<head>
    ...
    <meta name="description" content="Data Mahasiswa D3 Teknik Informatika">
    <meta name="author" content="Indra Styawantoro">

    <!-- Title -->
    <title>Data Mahasiwa D3 Teknik Informatika</title>
...
<body class="d-flex flex-column h-100">
    ...
    <header>
        <!-- Navbar -->
        <nav class="navbar navbar-expand-lg fixed-top bg-danger shadow">
            <div class="container">
                <span class="navbar-brand text-white">
                    <i class="fa-solid fa-university me-2"></i> 
                    Data Mahasiswa <span class="d-none d-md-inline">D3 Teknik Informatika</span>
                </span>
    ...
    <footer class="footer mt-auto bg-white shadow py-4">
        <div class="container">
            ...
            <div class="copyright text-center mb-2 mb-md-0">
                &copy; 2023 - <a href="https://pustakakoding.com/" target="_blank" class="text-brand text-decoration-none">by nora elvita</a>. All rights reserved.
            </div>
        </div>
    </footer>
